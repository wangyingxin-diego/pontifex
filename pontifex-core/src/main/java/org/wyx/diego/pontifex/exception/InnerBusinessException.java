...
public enum InnerBusinessException implements BusinessException {
    ...
    INNER_BUSINESS_EXCEPTION_SERVICE_ERROR(ExceptionCode.EXCEPTION_CODE_BUSINESS_ERROR.getCode(), ExceptionCode.EXCEPTION_CODE_BUSINESS_ERROR.getMsg(), ExceptionLevel.EXCEPTION_MUST),

    INNER_BUSINESS_EXCEPTION_HTTP_METHOD_NO_SUPPORT(9000005, "不支持httpMethod", ExceptionLevel.EXCEPTION_MUST),
